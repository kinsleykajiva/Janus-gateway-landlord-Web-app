...
/*the following is just load or make a reference but this can be done better or saved elsewhere*/
	...
	private static final JSONObject    KNOWN_ISSUES_SINCE_START_UP     = new JSONObject();
	private static final StringBuilder lastExecuteBashCommandResponses = new StringBuilder();
