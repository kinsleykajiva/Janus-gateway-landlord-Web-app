...
public class JanusOverFilesWrites {
    ...
    private static String SETTINGS_JS = """
            ...
            if(window.location.protocol === 'http:')
            	server = "http://${XUtils.MACHINE_PUBLIC_IP}:8088/janus";
            else
            	server = "https://${XUtils.MACHINE_PUBLIC_IP}:8089/janus";
    ...
    public static String getSettingsJs(){
        Map<String, String> valuesMap = new HashMap<>();
        valuesMap.put("XUtils.MACHINE_PUBLIC_IP", XUtils.MACHINE_PUBLIC_IP);
        StringSubstitutor sub = new StringSubstitutor(valuesMap);
       return sub.replace(SETTINGS_JS);
    }
